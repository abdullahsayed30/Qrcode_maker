...
def wifi_window():
    ...
    canvas = tk.Canvas(window2, width=380, height=380, bg="#ffffff")
    ...
    logo_window2 = Label(window2, image=logo_icon_s, bg="#ffffff")
    logo_window2.grid(column=0, columnspan=2, row=0)
    
    # Label 1
    lab1 = Label(window2, text="Wifi Password Share", font=("Comic Sans MS", 13, "bold"), bg="#ffffff")
    lab1.grid(column=0, row=1, columnspan=2)
    
    # Water Marks
    # 1         
    water_mark_window2_1 = Label(window2, image=water_mark_window2_1_photo, bg="#ffffff")
    water_mark_window2_1.place(x=70, y=101)
    # 2
    water_mark_window2_2 = Label(window2, image=water_mark_photo_1, bg="#ffffff")
    water_mark_window2_2.place(x=-40, y=50)
    # 3
    water_mark_window2_3 = Label(window2, image=water_mark_photo_1, bg="#ffffff")    
    water_mark_window2_3.place(x=345, y=270)
    # 4
    water_mark_window2_4 = Label(window2, image=water_mark_photo_3, bg="#ffffff")
    water_mark_window2_4.place(x=26, y=169)
    # 5
    water_mark_window2_5 = Label(window2, image=water_mark_photo_4, bg="#ffffff")
    ...
    canvas_2 = tk.Canvas(labelFrame2, width=300, height=0, highlightthickness=0, bg="#ffffff")
    ...
    s.configure("primary.Outline.TButton", font=("Comic Sans MS", 13), background="#ffffff")
...
# Frame 1
frame_1 = Frame(main_window, bg="#ffffff")
frame_1.pack()

# Logo
logo = Label(frame_1, image=logo_icon_l, bg="#ffffff")
logo.grid(column=0, row=0, columnspan=2, pady=15)

# NameOfLogo
nameOfLogo = Label(frame_1, text="Qrcode Maker", font=("Comic Sans MS", 15, "bold"), bg="#ffffff")
nameOfLogo.grid(column=0, row=1, columnspan=2, pady=10, sticky="NESW")

# Frame 2
frame_2 = Frame(main_window, bg="#ffffff")
frame_2.pack()

# ----------------------WaterMarks---------------------
# 1
water_mark_photo_1 = PhotoImage(file="Images/water_mark_1.png")
water_mark_1 = Label(main_window, image=water_mark_photo_1, bg="#ffffff")
water_mark_1.place(x=409, y=390)
# 2
water_mark_2 = Label(main_window, image=water_mark_photo_1, bg="#ffffff")
water_mark_2.place(x=-40, y=60)
# 3
water_mark_photo_2 = PhotoImage(file="Images/water_mark_2.png")
water_mark_3 = Label(main_window, image=water_mark_photo_2, bg="#ffffff")
water_mark_3.place(x=360, y=-22)
# 4
water_mark_photo_3 = PhotoImage(file="Images/water_mark_3.png")
water_mark_4 = Label(main_window, image=water_mark_photo_3, bg="#ffffff")
water_mark_4.place(x=-17, y=440)
# 5
water_mark_photo_4 = PhotoImage(file="Images/water_mark_4.png")
water_mark_5 = Label(main_window, image=water_mark_photo_4, bg="#ffffff")
...
s.configure("TLabelframe.Label", font=("Comic Sans MS", 10), background="#ffffff")
s.configure("TLabelframe", background="#ffffff")
...
s.configure("Outline.TButton", font=("Comic Sans MS", 10), background="#ffffff")
button2.grid(column=0, row=6, columnspan=2, padx=10, pady=5)

# copyright label
label2 = Label(frame_2, text="Copyright © 2021 Abdullah Sayed Sallam. All rights reserved", font=("Comic Sans MS", 8), bg="#ffffff")
